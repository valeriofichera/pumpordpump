...
export const db = [
  ...
  },
  {
  ...
  },
    {
      "name": "Shibe",
      "ticker": "SHIB",
      "description": "ShibeCoin is a meme-based cryptocurrency inspired by Shiba Inu dogs, aiming to bring joy and laughter to the crypto world.",
      "mcap": "15B",
      "created": "2021",
      "price": "0.00007",
    ...
    },
    {
      "name": "Fluffy",
      "ticker": "FLUF",
      "description": "FluffyCoin is a fluffy meme coin created for crypto enthusiasts who believe in lighthearted, soft currency.",
      "mcap": "5B",
      "created": "2022",
      "price": "0.02",
    ...
    },
    {
      "name": "Wagmi",
      "ticker": "WAGMI",
      "description": "WAGMICoin represents the optimism of the crypto world, reminding everyone 'We Are All Gonna Make It!'",
      "mcap": "3B",
      "created": "2020",
      "price": "0.5",
    ...
    },
    {
      "name": "Pepe",
      "ticker": "PEPE",
      "description": "PepeCoin is a tribute to internet culture and meme lovers, featuring everyone's favorite frog as its mascot.",
      "mcap": "10B",
      "created": "2019",
      "price": "0.001",
    ...
    },
    {
      "name": "MemeGold",
      "ticker": "MGOLD",
      "description": "MemeGold is a parody coin that shines with meme energy, bringing value to jokes and humor in the digital economy.",
      "mcap": "8B",
      "created": "2021",
      "price": "0.05",
    ...
    },
    {
      "name": "LaughCoin",
      "ticker": "LAUGH",
      "description": "LaughCoin is the currency for sharing laughs, bringing lightheartedness to the serious world of crypto.",
      "mcap": "500M",
      "created": "2023",
      "price": "0.007",
    ...
    },
    {
      "name": "RocketPup",
      "ticker": "RPUP",
      "description": "RocketPup is a coin that aims for the moon, literally, as it gains popularity among meme enthusiasts.",
      "mcap": "7B",
      "created": "2020",
      "price": "0.04",
